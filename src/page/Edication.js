...
import EducationInf from '../companent/profile/EducationInf';
 function Edication({ profFunc}) {
...
function mapDispatchToProps(dispatch) {
  return {
     profFunc: () => dispatch({type:'EDICFUNC'})
  }
 
}
export default connect(mapStateToProps, mapDispatchToProps)( Edication)